"""Dynamic pricing settings for Lapakin tiers."""
...
def _default_pricing_payload():
    ...
    for tier in TIER_ORDER:
        ...
        tiers[tier] = {
            ...
            "price_idr_month": _normalize_price(limits.get("price_idr_month", 0)),
            "price_idr_year": _normalize_price(limits.get("price_idr_year", 0)),
        }
