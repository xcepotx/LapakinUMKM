...
import AdminBillingMonitor from "@/pages/admin/AdminBillingMonitor";
import AdminPayments from "@/pages/admin/AdminPayments";
import AdminStoreHealth from "@/pages/admin/AdminStoreHealth";
...
function AppRouter() {
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/onboarding" element={<AdminRoute><AdminOnboardingQueue /></AdminRoute>} />
