...
function AIWaBotBanner() {
  ...
  if (connected) return (
    <div className="mb-6 rounded-2xl p-4 border border-green-200 bg-green-50 flex items-center justify-between gap-4">
      ...
      <button onClick={handleConnect} disabled={loading}
        className="text-sm font-bold text-green-700 hover:underline bg-transparent border-none cursor-pointer">
